...
st.set_page_config(page_title="Analisi Postura Sciatore", layout="centered")
...
if st.session_state.page == "home":
    st.markdown("<h1>🏂 Analisi Postura Sciatore</h1>", unsafe_allow_html=True)
    st.markdown("<h3>Carica un'immagine per avviare l'analisi posturale</h3>", unsafe_allow_html=True)
